...
var cmdBuild = &command{
  run:   runBuild,
  Name:  "build",
  Usage: "[-target android|linux|" + strings.Join(applePlatforms, "|") + "] [-o output] [-bundleid bundleID] [build flags] [package]",
...
You can also specify -target=linux/arm,linux/386,.. too. 

...
// Code generated by 'gojava help documentation doc.go'. DO NOT EDIT.
...
Commands:
	...
	clean       remove object files and cached gojava files
...
Usage:
	...
	gojava bind [-target android|ios|iossimulator|macos|maccatalyst] [-bootclasspath <path>] [-classpath <path>] [-o output] [build flags] [package]
...
For Apple -target platforms, gojava must be run on an OS X machine with
...
Usage:
	...
	gojava build [-target android|ios|iossimulator|macos|maccatalyst] [-o output] [-bundleid bundleID] [build flags] [package]
...
Remove object files and cached gojava files

Usage:

	gojava clean

Clean removes object files and cached NDK files downloaded by gojava init
...
Usage:
	...
	gojava install [-target android] [build flags] [package]
...
Version prints versions of the gojava binary and tools
*/
